...
if __name__ == "__main__":
	subj_path = "quote.tok.gt9.5000"
	obj_path = "plot.tok.gt9.5000"

	subj_lines = open(subj_path, 'r', encoding = "ISO-8859-1").readlines()
	obj_lines = open(obj_path, 'r', encoding = "ISO-8859-1").readlines()
