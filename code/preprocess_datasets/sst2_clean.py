...
if __name__ == "__main__":
	...
	data_path = 'data/stanford_sentiment_treebank/datasetSentences.txt'
	labels_path = 'data/stanford_sentiment_treebank/sentiment_labels.txt'
	split_path = 'data/stanford_sentiment_treebank/datasetSplit.txt'
	dictionary_path = 'data/stanford_sentiment_treebank/dictionary.txt'
	...
	train_writer = open('data/sst2/train.txt', 'w')
	test_writer = open('data/sst2/test.txt', 'w')
